...
export function SkillsPage() {
  ...
  return (
    <div className={p.page}>
      <h1 className={p.pageTitle}>Mes compétences</h1>
      ...
      {loading ? <div className={p.spinner} /> : (
        <>
          <div className={s.addRow}>
            ...
            <button className={p.btnPrimary} onClick={handleAdd} disabled={adding || !selCat}>Ajouter</button>
          </div>
          ...
          <div className={s.list}>
            {skills.map((sk) => (
              ...
              <span className={s.level}>{LEVEL_LABEL[sk.expertiseLevel] ?? sk.expertiseLevel}</span>
